...
const DEFAULT_PLANS: Plan[] = [
  ...
  },
  {
    name: 'Pro',
    description:
      'Unlimited teams with Jira automation for growing distributed teams.',
    price: 8,
    period: '/ user / month',
    ...
    features: [
      ...
      'Unlimited standup configs',
      'Jira automation & transitions',
      'Slack thread-based routing',
