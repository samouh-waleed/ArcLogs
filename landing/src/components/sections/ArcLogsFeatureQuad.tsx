...
import { Brain, Link2, Mic, Users } from 'lucide-react';
...
const DEFAULT_FEATURES: [FeatureItem, FeatureItem, FeatureItem, FeatureItem] = [
  {
    ...
    description:
      'Team members submit updates on their own schedule, no synchronous meetings.',
  ...
  },
  {
    ...
    description:
      'Connect with Slack, Zapier, and your existing workflow tools easily.',
    color: 'bg-blue-100 text-blue-600',
  },
  {
    ...
    description:
      'Automatically surface blockers, sentiment, and key themes from daily check-ins.',
    color: 'bg-blue-100 text-blue-600',
  },
  {
    ...
    description:
      'Keep everyone on the same page and free up hours for deep work.',
    color: 'bg-blue-100 text-blue-600',
  },
];
      ...
      <div className="container">
        <div className="overflow-hidden rounded-[28px] border border-gray-100 bg-white px-6 py-10 shadow-sm lg:px-8">
          ...
          <div className="hidden lg:grid lg:grid-cols-[1fr_auto_1fr] lg:items-center lg:gap-4 xl:gap-8">
            ...
            <div className="flex min-w-[420px] justify-center px-4">
              <PhoneWithOverlay activeIndex={active} />
            </div>
