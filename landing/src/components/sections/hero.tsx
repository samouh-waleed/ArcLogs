            ...
            <div className="flex flex-col justify-center gap-8 pb-6">
              <div className="flex flex-col gap-8">
                <div className="flex flex-col items-start gap-4">
                  {/* Product Tagline */}
                  <span className="text-body-sm-medium inline-flex h-8 w-fit items-center justify-center gap-2 rounded-[10px] bg-white px-3 leading-none whitespace-nowrap shadow-md">
