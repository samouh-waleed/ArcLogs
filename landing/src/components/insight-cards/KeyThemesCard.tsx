...
import { GitPullRequest, Settings, PenTool } from 'lucide-react';
...
export default function KeyThemesCard({
  ...
  return (
    <div
      className={`bg-white rounded-xl shadow-2xl p-4 w-full max-w-[200px] ${className}`}
    >
